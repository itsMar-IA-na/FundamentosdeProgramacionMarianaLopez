...
descuento_1 = calculo_desc(valor_total_1, valor_desc_1)  # Llamar a la función calculo_desc con valor_total_1 y valor_desc_1, y almacena el descuento calculado en descuento_1.
...
descuento_2 = calculo_desc(valor_total_2, valor_desc_2)  # Llamar a la Función calculo_desc con valor_total_2 y valor_desc_2, y almacena el descuento calculado en descuento_2.
