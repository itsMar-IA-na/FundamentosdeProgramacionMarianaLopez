...
print(f"De la compra 1 el valor total sin descuento es: {valor_total_1:.3f}, el porcentaje de descuento es 15%, el valor del descuento es = {descuento_1:.3f}, el valor final a pagar es = {valor_final_1:.3f}")
